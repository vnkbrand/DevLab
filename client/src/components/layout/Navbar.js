//  Shortcut - use rfc + Tab to get functional component... used for dumb components

// Use rcc + Tab - for classed-based component
...
class Navbar extends Component {
  ...
  render() {
    ...
    //  Links if a user is not logged in
    const guestLinks = (
      <ul className="navbar-nav ml-auto">
      <li className="nav-item">
    ...
    <div className="container">
      <Link className="navbar-brand" to="/">DevLab</Link>
